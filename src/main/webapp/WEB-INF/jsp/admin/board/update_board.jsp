					...
					<div class="row">
						...
						<div class="col-12">
							...
							<form name="update_form" action="<c:url value='/admin/board/update_board.do' />" method="post" encType="multipart/form-data">
								<div class="card card-primary">
									...
									<div class="card-body">
										<div class="form-group">
											...
											<input value="${result.nttSj}" type="text" class="form-control" name="nttSj " id="user_id" placeholder="제목을 입력해주세요." required>
										...
										<div class="form-group">
											...
											<input value="${result.frstRegisterNm}" type="text" class="form-control" name="frstRegisterNm" id="frstRegisterNm" placeholder="작성자를 입력해주세요" required>
										</div>
								...
								<!-- 버튼영역 시작 -->
								<div class="card-body">
									<button id="btn_view" type="button" class="btn btn-warning float-right mr-1">이전</button>
