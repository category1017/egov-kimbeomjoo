								...
								<div class="card card-primary">
									...
									<div class="card-body">
										<div class="form-group">
											...
											<input value="" type="text" class="form-control" name="nttSj " id="nttSj" placeholder="제목을 입력해주세요." required>
										...
										<div class="form-group">
											...
											<input disabled value="${LoginVO.name}" type="text" class="form-control" name="frstRegisterNm" id="frstRegisterNm" placeholder="작성자를 입력해주세요" required>
										</div>
