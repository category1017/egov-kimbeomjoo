  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">권한등록</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">권한등록</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">    
      <div class="container-fluid">
		...
		<div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
         ...
         <!-- form start -->
            <form name="write_form" action="<c:url value='/admin/authorrole/insert_author.do' />" method="post">
         <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Insert AuthorRole</h3>
              </div>
              <!-- /.card-header -->
					...
					<div class="form-group">
                  	...
                  	<select class="form-control" name="AUTHOR_CODE" id="AUTHOR_CODE">
                  		<c:forEach items="${codeGroup}" var="sub">
                  			<option value="${sub.value.group_nm}">${sub.value.group_nm}</option>
                  		</c:forEach>
                  	</select>                  		
                    </div>
					<div class="form-group">
              ...
              <div class="card-body">
	              ...
	              <button type="submit" class="btn btn-warning float-right mr-1">등록</button>
