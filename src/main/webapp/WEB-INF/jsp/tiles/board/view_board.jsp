		...
		<div class="bodytext_area box_inner">			
			<ul class="bbsview_list">
				...
				<li class="bbs_content">
					<div class="editer_content" style="line-height:1.8em;"> <!-- 글자간격 글꼴크기의 1.8배 -->
					    ${result.nttCn}
                    </div>
				</li>
			...
			<p class="btn_line txt_right">
				...
				<c:if test="${LoginVO.id ne null && LoginVO.uniqId eq result.frstRegisterId}"> <!-- 로그인한 사람만 삭제, 수정 가능-->
