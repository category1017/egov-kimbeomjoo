...
<link rel="stylesheet" href="<c:url value='/resources/home/css/join.css' />">
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<!-- 폼영역 -->
			<form method="POST" name="mypage_form" action="<c:url value='/tiles/mypage_form.do' />" class="appForm">
				<fieldset>
					<legend>회원가입폼</legend>
					...
					<ul class="app_list">
						...
						<li class="clear">
							<label for="password_hint_lbl" class="tit_lbl pilsoo_item">비밀번호 힌트</label>
							<div class="app_content">
							<input  value="${memberVO.PASSWORD_HINT}" type="text" name="PASSWORD_HINT" class="w100p" id="password_hint" placeholder="비밀번호 힌트를 입력해주세요" required/></div>
						</li>
						<li class="clear">
							<label for="password_cnsr_lbl" class="tit_lbl pilsoo_item">비밀번호 힌트답변</label>
							<div class="app_content">
							<input value="${memberVO.PASSWORD_CNSR}" type="text" name="PASSWORD_CNSR" class="w100p" id="password_cnsr" placeholder="비밀번호 힌트답변을 입력해주세요" required/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							<label for="sesdstn_code_lbl" class="tit_lbl pilsoo_item">성별</label>
							<div class="app_content radio_area">
								<input value="M" type="radio" name="SEXDSTN_CODE" class="css-radio" id="man_lbl" <c:out value="${memberVO.SEXDSTN_CODE eq 'M'?'checked':'' }"/> />
								<label for="man_lbl">남</label>
								<input value="F" type="radio" name="SEXDSTN_CODE" class="css-radio" id="woman_lbl" <c:out value="${memberVO.SEXDSTN_CODE eq 'F'?'checked':'' }"/> />
