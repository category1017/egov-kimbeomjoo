				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" name="PASSWORD_HINT" class="w100p" id="password_hint" placeholder="비밀번호 힌트를 입력해주세요" required/></div>
						</li>
						<li class="clear">
							<label for="password_cnsr_lbl" class="tit_lbl pilsoo_item">비밀번호 힌트답변</label>
							<div class="app_content"><input type="text" name="PASSWORD_CNSR" class="w100p" id="password_cnsr" placeholder="비밀번호 힌트답변을 입력해주세요" required/></div>
						</li>
						<li class="clear">
